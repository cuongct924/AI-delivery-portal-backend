...
The `llmops-golden-paths-agent` client still needs registering by hand in Thunder
...
THUNDER_CLIENT_ID: Final[str] = os.getenv("THUNDER_CLIENT_ID", "llmops-golden-paths-agent")
